...
```text
FairFlow_Guardian_complete_walkthrough_from_pdf_male_narrated.mp4
```

This is a 2:00, 1920x1080 MP4 generated from `submission/docs/FairFlow_Guardian_complete_walkthrough.pdf` with a neutral male voiceover.

Also included:

```text
FairFlow_Guardian_complete_walkthrough_from_pdf.mp4
FairFlow_Guardian_complete_walkthrough_voiceover_male.txt
